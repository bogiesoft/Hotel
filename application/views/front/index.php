        ...
        <div class="tab-pane active po-re" id="tab_b"><!-- first tap ------------------------------------------------------------- -->
            ...
            <div class="row"><!-- main row of results -->
                ...
                <div class="row one-room">
                    ...
                    <div class="row one-room">
                            ...
                            <div id="carousel" class="carousel slide magni" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active" data-thumb="0">
                                        <a class="fancybox" rel="group" href="<?php echo site_url('assets/front');?>/img/slide1.png"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></a>
                                    </div>
                        ...
                        <div class="clearfix">
                            <div id="thumbcarousel" class="carousel slide" data-interval="false">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <div data-target="#carousel" data-slide-to="0" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel" data-slide-to="1" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel" data-slide-to="2" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel" data-slide-to="3" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                    </div><!-- /item -->
                                    <div class="item">
                                        <div data-target="#carousel" data-slide-to="4" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel" data-slide-to="5" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel" data-slide-to="6" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel" data-slide-to="7" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                    </div><!-- /item -->
                                </div><!-- /carousel-inner -->
                                <a class="left carousel-control" href="#thumbcarousel" role="button" data-slide="prev">
                                    <span class="glyphicon glyphicon-chevron-left"></span>
                    ...
                    <div class="row">
                        <div class="col-md-12" id="dtl-show1">
                            <img src="<?php echo site_url('assets/front');?>/img/room-inf.png" alt="" /><!-- -->
                            <span>Show room information</span>
                        </div>
                    </div>
                    ...
                    <div class="row dtl1">
                        <div class="col-md-5">
                            <p class="room-dtl">
                            <b>1 queen and 1 sofa bed</b><br />
                            247 sq feet (23 sq meters)<br />
                            <b>Relax</b> - Fireplace<br />
                            <b>Entertainment</b> - Free WiFi, 32-inch LCD TV with satellite channels<br />
                            <b>Food &amp; Drink</b> - Refrigerator, minibar, and coffee/tea maker<br />
                            <b>Sleep</b> - Premium bedding and a sofa bed<br />
                            <b>Bathroom</b> - Private bathroom with a shower, bathrobes, and slippers
                            </p>
                        </div>
                        <div class="col-md-7">
                            <h4>Room Details</h4>
                            <span class="dtl">Air conditioning</span>
                            <span class="dtl">Bathrobes</span>
                            <span class="dtl">Coffee/tea maker</span>
                            <span class="dtl">Complimentary bottled water</span>
                            <span class="dtl">Complimentary toiletries</span>
                            <span class="dtl">Cribs/infant beds available</span>
                            <span class="dtl">Desk</span>
                            <span class="dtl">DVD player</span>
                            <span class="dtl">Fireplace</span>
                            <span class="dtl">Free Wi-Fi</span>
                            <span class="dtl">Hair dryer</span>
                            <span class="dtl">HD TV</span>
                            <span class="dtl">Individually decorated</span>
                            <span class="dtl">Individually furnished</span>
                            <span class="dtl">In-room safe (laptop compatible)</span>
                            <span class="dtl">iPod docking station</span>
                            <span class="dtl">Iron/ironing board</span>
                            <span class="dtl">LCD TV</span>
                            <span class="dtl">Minibar</span>
                            <span class="dtl">Phone</span>
                            <span class="dtl">Pillow menu</span>
                            <span class="dtl">Premium bedding</span>
                            <span class="dtl">Private bathroom</span>
                            <span class="dtl">Refrigerator</span>
                            <span class="dtl">Rollaway/extra beds available</span>
                            <span class="dtl">Room service (24 hours)</span>
                            <span class="dtl">Satellite TV service</span>
                            <span class="dtl">Shower only</span>
                            <span class="dtl">Slippers</span>
                            <span class="dtl">Sofa bed</span>
                        </div>
                    </div>


                    <div class="row one-room">
                        <div class="col-md-3 nopadding" id="slider-content2">
                            <div id="green-offer">
                                Free cancellation
                            </div>
                            <div class="room-title c-fff bg-000">
                        ...
                        <div class="clearfix">
                            <div id="thumbcarousel2" class="carousel slide" data-interval="false">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <div data-target="#carousel2" data-slide-to="0" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel2" data-slide-to="1" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel2" data-slide-to="2" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel2" data-slide-to="3" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                    </div><!-- /item -->
                                    <div class="item">
                                        <div data-target="#carousel2" data-slide-to="4" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel2" data-slide-to="5" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel2" data-slide-to="6" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                        <div data-target="#carousel2" data-slide-to="7" class="thumb"><img src="<?php echo site_url('assets/front');?>/img/slide1.png" /></div>
                                    </div><!-- /item -->
                                </div><!-- /carousel-inner -->
                        ...
                        <div class="col-md-9">
                            <div class="row data-row">
                                ...
                                <div class="col-md-3">
                                    <select class="sl-menu">
                                        <option data-room="0" data-promotion="0" data-qty="0" data-price="0" data-type="delete" value="0-0">Select</option>
                                        <option data-room="2" data-promotion="0" data-qty="1" data-price="100" data-type="add">1 - 100 &euro;</option>
                                        <option data-room="2" data-promotion="0" data-qty="2" data-price="200" data-type="add">2 - 200 &euro;</option>
                                        <option data-room="2" data-promotion="0" data-qty="3" data-price="300" data-type="add">3 - 300 &euro;</option>
                                    </select><br />
                                    We Have 3 rooms left!
                                </div>
                            </div>
                            <div class="row data-row">
                                ...
                                <div class="col-md-3">
                                    <select class="sl-menu">
                                        <option data-room="0" data-promotion="0" data-qty="0" data-price="0" data-type="delete" value="0-0">Select</option>
                                        <option data-room="2" data-promotion="1" data-qty="1" data-price="100" data-type="add">1 - 100 &euro;</option>
                                        <option data-room="2" data-promotion="1" data-qty="2" data-price="200" data-type="add">2 - 200 &euro;</option>
                                        <option data-room="2" data-promotion="1" data-qty="3" data-price="300" data-type="add">3 - 300 &euro;</option>
                                    </select><br />
                                    We Have 3 rooms left!
                                </div>
                            </div>
                    ...
                    <div class="row">
                    <div class="col-md-12" id="dtl-show2">
                        <img src="<?php echo site_url('assets/front');?>/img/room-inf.png" alt="" />
                        <span>Show room information</span>
                    </div>
                    </div>
