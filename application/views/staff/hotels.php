<?php $this->load->view('staff/header'); ?>
    <div class="pageheader">
      <h2><i class="fa fa-building-o"></i> Oteller</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">Buradasınız</span>
        <ol class="breadcrumb">
          <li><a href="<?php echo site_url('staff/hotels'); ?>">Admin</a></li>
...
<script type="text/javascript">
    ...
    //Localization texts
        ...
        $('#hotels').jtable({
            ...
            actions: {
                listAction: '<?php echo site_url("staff/hotels/get_hotels"); ?>'
            },
            fields: {
                id: {
                    key: true,
                ...
                detail:{
                  ...
                  display: function (data) {
                      return $('<a href="'+base_url+'staff/hotel_edit/' + data.record.id + '"><img  style="opacity:0.4; width:16px; height:16px; margin-bottom:3px; padding:0;" src="<?php echo site_url("assets/jtable/themes/metro/edit.png"); ?>" /></a>');
                  }
                }
