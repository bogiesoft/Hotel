...
function credit_cards(){
	$cards = array(
		...
		'5' => array('name' => 'JCB', 'class' => 'jcb'),
		'6' => array('name' => 'American Express', 'class' => 'aexpress'),
		'7' => array('name' => 'Swithc', 'class' => 'switch'),
		'8' => array('name' => 'Union Pay', 'class' => 'union-pay'),
		'9' => array('name' => 'Electronic Cash', 'class' => 'ec'),
		'10' => array('name' => 'HiperCard', 'class' => 'hiper'),
		'11' => array('name' => 'Carte Bleue', 'class' => 'carte-bleue'),
		'12' => array('name' => 'Solo (debit)', 'class' => 'solo'),
		'13' => array('name' => 'CartaSi', 'class' => 'cartasi'),
		'14' => array('name' => 'Carte Blanche', 'class' => 'blancho'),
		'15' => array('name' => 'EftPos', 'class' => 'eftpos'),
		'16' => array('name' => 'Mister Cash', 'class' => 'bancontact'),
		'17' => array('name' => 'NicoS', 'class' => 'nicos'),
		'18' => array('name' => 'Red Compra', 'class' => 'red-card'),
		'19' => array('name' => 'BC Card', 'class' => 'bc'),
		'20' => array('name' => 'Cabal', 'class' => 'cabal'),
		'21' => array('name' => 'Bank Card (AU)', 'class' => 'b-cart'),
		);
